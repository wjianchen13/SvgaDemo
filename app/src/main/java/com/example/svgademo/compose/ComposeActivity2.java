...
import com.example.svgademo.webp.WebpAdapter3;
...
public class ComposeActivity2 extends AppCompatActivity {
    ...
    private ComposeAdapter2 adapter;
    ...
    public void onTest1(View v) {
        ...
        for(int i = 0; i < 100; i ++) {
            ...
            if(i % 2 == 0) {
                ...
                data.setType(1);
                data.setmUrl("https://img.ayomet.com/upload/headwear_svga/2023-05-26/f3adf43912c7379decea77d6366d6b03.svga?imageslim");
            }
            list.add(data);
        }
        adapter = new ComposeAdapter2(this, list);
